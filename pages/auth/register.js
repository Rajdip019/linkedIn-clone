  ...
  return(
    ...
    <img src="/logo.jpeg" alt="" className="w-36 mx-auto" />
        ...
        />
          ...
          className="h-12 px-5 w-full my-3  ring-1 ring-gray-400 focus:ring-blue-500 focus:border-blue-500 active:ring-blue-500 active:ring-1 focus:ring-1 focus:border-0 active:border-0 active:border-blue-500 rounded text-lg"
        />
        <input
          type="password"
          name=""
        ...
        <p className="text-center mt-10">
         Alredy on LinkedIn?  <Link href="/auth/signin"><span className="text-skin-main cursor-pointer group-visited:text-blue-700 hover:underline transition-all font-semibold">Sign in</span></Link>
        </p>
    </div>
      </>
  );
